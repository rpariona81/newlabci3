...
/*
 * t_marco_poblacion -- distritos segun ZONA_SUNAT
 * t_contpotenciales -- registro de cuestionarios
 * t_marco_viv -- listado de ubigeo, zonas, conglomerados
 * carga_usuario_viv -- conteo de registros segun usuario
 * ubigeo_zonas -- conteo de conglomerados segun ubigeo y zona
 */

/**
 * Description of Usupotenciales_model
 * Ronald Pariona
 */
class Usupotenciales_model extends CI_Model {
