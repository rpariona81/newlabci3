 ...
 * @author locador1dnce
 */
class Usupotenciales extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->dbutil();
        $this->load->model('Usupotenciales_model');
    ...
    public function index() {
        ...
        if ($this->perfil < 6) {
            $data['cuestionarios'] = $this->Usupotenciales_model->listcuest2();
            $data['contenido'] = 'usupotenciales/index_control';
        } else {
            $data['cuestionarios'] = $this->Usupotenciales_model->listcuestusuario($this->usuario);
            $data['contenido'] = 'usupotenciales/index';
        }
    ...
    public function todos() {
        $data = array();
        if ($this->perfil < 6) {
            $data['cuestionarios'] = $this->Usupotenciales_model->listcuest();
            $data['contenido'] = 'usupotenciales/index_control';
        } else {
    ...
    public function create() {
        ...
        $data['contenido'] = 'usupotenciales/create';
        $data['titulo'] = 'ENC. A USUARIOS POTENCIALES';
        $data['orden'] = 1;
        $this->load->view('layout/main', $data);
    }
    ...
    public function ircuestionario($id = NULL) {
        ...
        $data['contenido'] = 'usupotenciales/cuest';
        $data['orden'] = 1;
        $this->load->view('layout/main', $data);
    }
