                    ...
                    <table id="datatablesSimple" name="datatablesSimple" class="table display nowrap table-hover table-bordered mb-0 border-top text-sm" style="width:100%">
                        ...
                        <tbody>
                            <?php foreach ($query as $item) : ?>
                                <?php
                                if ($item->vigency == 0) {
                                    echo '<tr class="text-black-90 align-middle">';
                                } else {
                                    echo '<tr class="text-info align-middle">';
                                } ?>
                                ...
                                <?php
                                if ($item->vigency == 0) {
                                    echo '<td><span class="badge bg-secondary border text-dark">' . $item->expired . '</span></td>';
                                } else {
                                    echo '<td><span class="badge bg-success border text-dark">' . $item->expired . '</span></td>';
                                } ?>
