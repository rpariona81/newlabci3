        ...
        <div class="card-body">
            ...
            <div class="col-auto">
                <select class="form-select" id="result" name="result" aria-label="Default select example" required>
                    ...
                    <option value="Verificado" <?= $postulacion->result == 'Verificado' ? ' selected="selected"' : ''; ?>>Verificado por la Unidad de Empleabilidad</option>
                    <option value="Enviado" <?= $postulacion->result == 'Enviado' ? ' selected="selected"' : ''; ?>>Enviado a la empresa/empleador</option>
                    <option value="Aceptado" <?= $postulacion->result == 'Aceptado' ? ' selected="selected"' : ''; ?>>Aceptado por la empresa/empleador</option>
                    <option value="Sin respuesta" <?= $postulacion->result == 'Sin respuesta' ? ' selected="selected"' : ''; ?>>Sin respuesta de la empresa/empleador</option>
                </select>
            </div>
            <div class="col-auto">
