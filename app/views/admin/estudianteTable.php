            ...
            <div class="card-header border-bottom pb-0">
                <div class="d-sm-flex align-items-center">
                    <div class="col-md-5 col-8 align-self-center">
                        <div class="mb-3">
                            <h5 class="text-dark">Estudiantes/Egresados</h5>
                        </div>
                    </div>
                    <div class="ms-auto d-flex">
                        <div class="mb-1">
                            <a class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down" data-toggle="tooltip" data-placement="bottom" title="Crear nuevo registro" href="/admin/newestudiante">Nuevo usuario&nbsp;&nbsp;<i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php foreach ($query as $item) : ?>
                                <tr class="align-middle">
                                    <td class="align-middle"><?= str_pad($item->id, 5, '0', STR_PAD_LEFT); ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            ?>
                                            &nbsp;&nbsp;
                                            <a class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Editar" href="/admin/estudiante/<?= $item->id ?>"><i class="fa fa-edit"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
