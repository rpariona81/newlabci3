                ...
                <div class="card-body">
                    <?php if ($this->session->flashdata('flashSuccess')) : ?>
                        <div class="d-grid gap-1">
                            <div class='p-2 alert alert-success'> <?= $this->session->flashdata('flashSuccess') ?> </div>
                        </div>
                    <?php endif ?>

                    <?php if ($this->session->flashdata('flashError')) : ?>
                        <div class="d-grid gap-1">
                            <div class='p-2 alert alert-danger'> <?= $this->session->flashdata('flashError') ?> </div>
                        </div>
                    <?php endif ?>

                    <?php if ($this->session->flashdata('flashInfo')) : ?>
                        <div class="d-grid gap-1">
                            <div class='p-2 alert alert-info'> <?= $this->session->flashdata('flashInfo') ?> </div>
                        </div>
                    <?php endif ?>

                    <?php if ($this->session->flashdata('flashWarning')) : ?>
                        <div class="d-grid gap-1">
                            <div class='p-2 alert alert-warning'> <?= $this->session->flashdata('flashWarning') ?> </div>
                        ...
                        <div class="form-row">
                            <div class="text-center mt-3">
                                <input class="btn btn-dark w-100 mb-1" id="btnLogin" type="submit" value="Ingresar"></input>
