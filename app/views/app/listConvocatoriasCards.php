        ...
        <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-2">
                <ul class="nav nav-tabs card-header-tabs" data-bs-tabs="tabs" id="convocatorias-list">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="true" data-bs-toggle="tab" href="#vigentes"><strong>Convocatorias vigentes</strong></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#novigentes"><strong>Convocatorias no vigentes</strong></a>
                    </li>
                </ul>
            </div>
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <ul class="list-unstyled mt-0 mb-4">
                                            <li>
                                                ...
                                                <span class="badge bg-info text-dark"><?= $item->expired ?></span>
                                            </li>
                                            <li>
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <ul class="list-unstyled mt-0 mb-4">
                                            <li>
                                                <i class="fa fa-calendar" style="height: 20px; width: 20px; text-align: center;"></i>
                                                <span>&nbsp;Finaliza el <?= date("d/m/Y", strtotime($item->date_vigency)); ?></span>&nbsp;
                                                <span class="badge bg-danger text-dark"><?= $item->expired ?></span>
                                            </li>
                                            <li>
                                                <i class="fa fa-map-marker" style="height: 20px; width: 20px; text-align: center;"></i>
                                                <span>&nbsp;<?= $item->ubicacion ?></span>
